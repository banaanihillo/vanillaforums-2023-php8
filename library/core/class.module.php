...
class Gdn_Module extends Gdn_Pluggable implements Gdn_IModule
{
    ...
    public function fetchViewLocation($view = "", $applicationFolder = "")
    {
        ...
        if (Gdn::controller() instanceof Gdn_Controller) {
            try {
                $viewPath = Gdn::controller()->fetchViewLocation(
                    $view,
                    "modules",
                    $applicationFolder
                );
        ...
        if (!$viewPath) {
            ...
            // 2. A theme
            if ($themeFolder != "") {
                // a. Application-specific theme view, eg.
                // /path/to/application/themes/theme_name/app_name/views/modules/
                ...
                // b. Garden-wide theme view. eg.
                // /path/to/application/themes/theme_name/views/modules/
                $viewPaths[] = combinePaths([
                    PATH_THEMES,
                    $themeFolder,
                    "views",
            ...
            // 3. Application default. eg.
            // /path/to/application/app_name/views/controller_name/
