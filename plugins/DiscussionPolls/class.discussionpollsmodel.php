...
class DiscussionPollsModel extends Gdn_Model {
     ...
     */
    public function SavePoll($FormPostValues) {
        //paranoid
        self::PurgeCache();
        try {
            ...
            foreach($QuestionIDs as $Index => $QuestionID) {
                // $QuestionOptions = ArrayValue(
                //     'DP_Options' . $Index,
                //     $FormPostValues,
                // );
                $QuestionOptions = $FormPostValues['DP_Options' . $Index] ?? [];
    ...
    public function CheckFullyAnswered($FormPostValues) {
        ...
        $Poll = $this->GetPoll($FormPostValues['PollID']);
